...
namespace WebApplication5.Controllers
{
    public class CoursesController : Controller
    {
        ...
        {
            var dbcoursesContext = _context.Courses.Include(c => c.Category).Include(c => c.DifficultyLevel).Include(c => c.PhotoUrl).Include(c => c.Teachers);
        ...
        public IActionResult Create()
        {
            ...
            ViewData["PhotoUrlId"] = new SelectList(_context.Photos, "Id", "Id");
            ViewData["TeachersId"] = new SelectList(_context.AspNetUsers, "Id", "Id");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Description,DifficultyLevelId,CategoryId,TeachersId,PhotoUrlId")] Course course)
        {
            ...
            ViewData["PhotoUrlId"] = new SelectList(_context.Photos, "Id", "Id", course.PhotoUrlId);
            ViewData["TeachersId"] = new SelectList(_context.AspNetUsers, "Id", "Id", course.TeachersId);
            return View(course);
        }
